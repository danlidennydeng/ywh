...
class AccountStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create account_status" do
    assert_difference('AccountStatus.count') do
      post account_statuses_url, params: { account_status: { name: @account_status.name, note: @account_status.note } }
    end
  ...
  test "should update account_status" do
    patch account_status_url(@account_status), params: { account_status: { name: @account_status.name, note: @account_status.note } }
