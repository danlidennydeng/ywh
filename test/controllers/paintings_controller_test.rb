...
class PaintingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post paintings_url, params: { painting: { image: @painting.image, name: @painting.name } }
    end
  ...
  test "should update painting" do
    patch painting_url(@painting), params: { painting: { image: @painting.image, name: @painting.name } }
