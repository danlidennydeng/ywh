...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference('Entity.count') do
      post entities_url, params: { entity: { edited_by: @entity.edited_by, name: @entity.name, note: @entity.note } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { edited_by: @entity.edited_by, name: @entity.name, note: @entity.note } }
