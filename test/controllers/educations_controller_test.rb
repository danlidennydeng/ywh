...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { edited_by: @education.edited_by, name: @education.name, note: @education.note } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { edited_by: @education.edited_by, name: @education.name, note: @education.note } }
